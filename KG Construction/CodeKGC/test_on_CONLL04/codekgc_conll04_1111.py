...
parser = argparse.ArgumentParser(description="CodeKGC for CoNLL04")
...
def codekgc(config_path: str = args.config):
    ...
    for i, item in enumerate(data):
        ...
        text_prompt = '\n""" ' + text + ' """'
        strict_instruction = "\nExtract triples using only the provided relations: Work For, Located In, Organization based in, Live In, Kill. Do not use or invent other relations."
        ...
        try:
            # Look for the "extract = Extract([ ... ])" part of the string
